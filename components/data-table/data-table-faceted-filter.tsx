              ...
              {options.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    {option.withCount && column?.getFacetedUniqueValues()?.get(option.value) && <span className="ml-auto flex items-center justify-center font-mono text-xs">{column?.getFacetedUniqueValues().get(option.value)}</span>}
                  </CommandItem>
                );
              })}
            </CommandGroup>
