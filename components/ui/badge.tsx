...
const badgeVariants = cva({
  ...
  variants: {
    variant: {
      ...
      success: "bg-green-100 text-green-800 dark:bg-green-950 dark:text-green-100 hover:[&[href],&[type]]:opacity-75",
      warning: "bg-orange-100 text-orange-800 dark:bg-orange-950 dark:text-orange-100 hover:[&[href],&[type]]:opacity-75",
      info: "bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-100 hover:[&[href],&[type]]:opacity-75",
      danger: "bg-red-100 text-red-800 dark:bg-red-950 dark:text-red-100 hover:[&[href],&[type]]:opacity-75",
    },
    size: {
...
const Badge = ({ children, className, asChild, variant, size, prefix, suffix, ...props }: BadgeProps) => {
