  ...
  return (
    <LazyMotion features={domAnimation}>
      <div className="w-full">
        ...
        <AnimatePresence>
          {selectedPerk && (
            <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={() => setSelectedPerk(null)}>
              <m.div
