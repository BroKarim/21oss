...
// Dummy data replacement for docsConfig
const dummyDocsConfig = {
  mainNav: [
    {
  ...
  return (
    <>
      <Button
        ...
        {...props}
      >
        <span className="hidden lg:inline-flex">Global Search...</span>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList>
          ...
          {dummyDocsConfig.sidebarNav.map((group) => (
