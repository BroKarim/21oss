  ...
  return (
    <Box hover>
      <ExternalLink className={cx("not-prose group relative rounded-md overflow-clip", className)} {...props}>
        ...
        <Button focus={false} suffix={<ArrowUpRight />} className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-0 pointer-events-none shadow-lg group-hover:opacity-100" asChild>
          <span>{children}</span>
        </Button>
      </ExternalLink>
    </Box>
