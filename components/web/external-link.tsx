...
export const ExternalLink = ({ href, target = "_blank", doTrack = true, doFollow = false, eventName, eventProps, ...props }: ExternalLinkProps) => {
  ...
  return <a href={finalHref!} target={target} rel={`noopener${doFollow ? "" : " nofollow"}`} onClick={() => isExternal && eventName && posthog.capture(eventName, eventProps)} {...props} />;
};
