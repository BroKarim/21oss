...
import { CategoryActions } from "@/app/admin/categories/_components/categories-actions";
...
export function CategoryForm({ className, title, category, toolsPromise, categoriesPromise, ...props }: CategoryFormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="items-stretch">
              ...
              <FormControl>
                <Select disabled={!!category?.subcategories.length} onValueChange={field.onChange} value={field.value ?? ""}>
                  <SelectTrigger>
