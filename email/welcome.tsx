...
const EmailWelcome = ({ name = "there", ...props }: EmailProps) => {
  ...
  return (
    <EmailWrapper preview={preview} signature {...props}>
      ...
      <Text>{config.site.name} is more than just a platform – its a community. Connect with like-minded open source enthusiasts, share your favorite projects, and be part of the movement.</Text>

      <Text>Heres what you can do in {config.site.name}:</Text>
      ...
      <ul>
        ...
        <li>
          <Text className="m-0">
            ...
            – Get your project in front of thousands of open source enthusiasts. It’s 100% free to submit.
          </Text>
        </li>
        ...
        <li>
          <Text className="m-0">
            ...
            – Choose one of the available options and promote your business or software on our website.
          </Text>
        </li>
      </ul>
