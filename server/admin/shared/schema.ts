...
export const contentSchema = z.object({
  tagline: z.string().describe("A compelling tagline (max 60 chars) that captures the tool's unique value proposition. Avoid tool name, focus on benefits."),
  description: z.string().describe("A concise meta description (max 160 chars) highlighting key features and benefits. Use active voice, avoid tool name."),
  content: z
    .string()
    .describe(
